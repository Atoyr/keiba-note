...
INSERT INTO `__new_note`("id", "author_id", "kind", "race_id", "horse_id", "race_entry_id", "body", "rating", "visibility", "occurred_at", "created_at", "updated_at") SELECT "id", "author_id", "kind", "race_id", "horse_id", "race_entry_id", "body", "rating", "visibility", "occurred_at", "created_at", "updated_at" FROM `note`;--> statement-breakpoint
