...
-- 未保存の件数と、保存したときの件数がそろうことを見る専用のレース（preview.e2e.ts）。
-- 出走2頭のうち1頭には出走前メモが保存済み。もう1頭に本文・札・印を付けて保存したとき、
-- 未保存も保存も「1件」になること（欄の数でも、保存済みのメモの総数でもない）を見る。
INSERT INTO race (id,date,course,race_number,name,surface,distance)
VALUES ('01JE2ERACECOUNT0000000000','2099-05-03','東京',9,'E2E件数賞','芝',1600);
...
VALUES ('01JE2ECOUNTPREVIEW0000000','01JE2EUSER0000000000000000','preview','01JE2ERACECOUNT0000000000','01JE2EHORSECOUNTA00000000','01JE2EENTRYCOUNTA00000000','保存済みのメモ。','○','2099-05-03',unixepoch('2026-01-01'));
